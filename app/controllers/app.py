...
from app.gui.widgets.comparison_entry_page import ComparisonEntryPage
from app.gui.widgets.comparison_statistic_detail_page import ComparisonStatisticDetailPage
from app.gui.widgets.comparison_statistic_page import ComparisonStatisticPage
from app.gui.widgets.general_statistic_page import GeneralStatisticPage
...
from app.gui.widgets.sync_page import SyncPage
...
class GuiApp():
    ...
    def run(self) -> None:
        ...
        navigator.navigate(PageName.SYNCHRONISATION_PAGE.value)
